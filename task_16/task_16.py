...
# В самом начале изучения Python делал много клмментариев прежде всего для пояснения самому себе,
# что делает та или иная функция.
# Однако, еще перед прохождением курса Чистый код, избавился от комментариев,
# правильно именуюя функции (методы) и переменные.
